function convertToUSD() { // FUNCTION FOR CONVERTING FROM USD TO COINS
    "use strict";
    ...
    xbtc.onreadystatechange = function(){
        if(xbtc.readyState == 4){
            ...
            price = ticker.USD; // live price of bitcoin 
            //converts  from the amount USD to BTC amount.
            $("#amountUSD1").html("You get: " + amount.value / price + " DASH");
            $("#testing1").html("Live Price: $" + price );
...
function convertFromUSD() { // FUNCTION FOR CONVERTING FROM COINS TO USD
    "use strict";
